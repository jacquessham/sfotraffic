...
CREATE TABLE IF NOT EXISTS OUT__SFO_STATS.OUT__PRICE_CATEGORY (
	PRICE_CATEGORY VARCHAR(256) PRIMARY KEY
);

CREATE TABLE IF NOT EXISTS OUT__SFO_STATS.OUT__PASSENGER_FLIGHTS_STATISTICS (
	PASSENGER_RECORD_ID VARCHAR(256),
	TERMINAL VARCHAR(256),
	BOARDING_AREA VARCHAR(256),
	...
	PRICE_CATEGORY VARCHAR(256) REFERENCES OUT__SFO_STATS.OUT__PRICE_CATEGORY (PRICE_CATEGORY),
	FLIGHT_DATE TIMESTAMP
);

CREATE TABLE IF NOT EXISTS OUT__SFO_STATS.OUT__CARGO_FLIGHTS_STATISTICS (
	CARGO_RECORD_ID VARCHAR(256),
	CARGO_AIRCRAFT_TYPE VARCHAR(256),
